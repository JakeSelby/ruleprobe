...
release reads 1 and 2. An entry without one takes the file's top-level `version`, and a file
without one is schema 1. An entry's own key wins over the file's. A value this release does
