...
change, and a release that ships a new detector adds its id to `SHIPPED_IDS`. An id is never
...
#: Every detector id any release has shipped in `DEFAULT`, in the order it first shipped.
SHIPPED_IDS = (
